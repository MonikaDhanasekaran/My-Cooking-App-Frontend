...
const ForgotPasswordComponent = () => {
    ...
    const handleAccountExists = async (e) => {
        if (e && formData.email) {
            axios
                .post("https://my-cooking-app.onrender.com/cook/forgotpassword", {
    ...
    const handleSubmit = (e) => {
        ...
        if (
            ...
            axios
                .post("https://my-cooking-app.onrender.com/cook/changepassword", {
                    email: formData.email,
                            ...
                            <Grid container>
                                <Card id="cardChangePassword">
                                    <CardContent>
                                        ...
                                        <br /> <br />
                                        <Button variant="contained" id="changePasswordButton" type="submit" onClick={handleSubmit} > Change </Button>
                                    </CardContent>
                                </Card>
                            </Grid>
                        </div>
